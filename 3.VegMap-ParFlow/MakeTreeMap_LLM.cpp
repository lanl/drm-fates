  ...
  //Opening Files
        ...
        for (int sl=0; sl < lcount; sl++) {// Loop through each tree location
           ...
           // Yarray[sl] = atof(Yloc.c_str());
            locstream>>spparray[sl]>>Xarray[sl]>>Yarray[sl]>>djnk>>djnk>>djnk>>djnk>>djnk; 
            //cout<<Xloc<<endl;
           ...
           for (int x=0; x < nx; x++) {
               ...
               for (int sl=0; sl < lcount; sl++) {// Checing Tree location
                   if ((Xarray[sl]>Xlow)&&(Xarray[sl]<Xhigh)&&(Yarray[sl]>Ylow)&&(Yarray[sl]<Yhigh)) {
                       cell = spparray[sl];
                       treenum=sl;
                       cout<<"X and Y fits: "<<Ylow<<"  "<<Yarray[sl]<<"  "<<Xarray[sl]<<"  "<<Yhigh<<"     "<<cell<<"  "<<treenum<<endl;
                   }
               } 
               checkfile<<x<<"  "<<y<<"  "<<cell<<"  "<<treenum<<endl;
