...
#pfset Geom.domain.ICPressure.FileName                   Spin.Press.3.pfb
#puts "Before press dist "
#pfdist Spin.Press.3.pfb
...
file copy -force Spin.Press.3.pfb $outputdir/Spin.Press.3.pfb
file copy -force Spin.Press.3.pfb.dist $outputdir/Spin.Press.3.pfb.dist
