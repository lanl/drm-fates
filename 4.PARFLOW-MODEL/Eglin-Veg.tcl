...
#pfset GeomInput.sandinput.GeomName   "sand"
#pfset GeomInput.sandinput.InputType  Box
...
## Sand Geometry 
##---------------------------------------------------------
#pfset Geom.sand.Lower.X                        0.0
#pfset Geom.sand.Lower.Y                        0.0
#pfset Geom.sand.Lower.Z                        0.0
#
#pfset Geom.sand.Upper.X                        400.0
#pfset Geom.sand.Upper.Y                        200.0
#pfset Geom.sand.Upper.Z                        0.10
...
#pfset Geom.sand.Perm.Type            TurnBands
#pfset Geom.sand.Perm.Value           0.239
#pfset Geom.sand.Perm.LambdaX            50.0
#pfset Geom.sand.Perm.LambdaY            50.0
#pfset Geom.sand.Perm.LambdaZ            5.0
#pfset Geom.sand.Perm.GeomMean            0.239
#pfset Geom.sand.Perm.Sigma               1.0
#pfset Geom.sand.Perm.Seed                1
#pfset Geom.sand.Perm.NumberLines         150
#pfset Geom.sand.Perm.RZeta               5.0
#pfset Geom.sand.Perm.KMax                100.0000001
#pfset Geom.sand.Perm.DelK                0.2
#pfset Geom.sand.Perm.MaxNPts             5
#pfset Geom.sand.Perm.MaxCpts             200
#pfset Geom.sand.Perm.LogNormal           Log
#pfset Geom.sand.Perm.StratType           Bottom 
...
pfset TimingInfo.StopTime         24
pfset TimingInfo.DumpInterval     -1
pfset TimeStep.Type              Constant
pfset TimeStep.Value             1
#pfset TimeStep.Value             100
...
pfset Geom.domain.Porosity.Value         0.43
#pfset Geom.sand.Porosity.Type          Constant
#pfset Geom.sand.Porosity.Value         0.47
...
pfset Geom.domain.RelPerm.Alpha         4.9
pfset Geom.domain.RelPerm.N             1.4 
#pfset Geom.sand.RelPerm.Alpha         2.7
#pfset Geom.sand.RelPerm.N             2.9
...
pfset Geom.domain.Saturation.Alpha        4.9
pfset Geom.domain.Saturation.N            1.4
pfset Geom.domain.Saturation.SRes         0.05
pfset Geom.domain.Saturation.SSat         1.0
#pfset Geom.sand.Saturation.Alpha        2.7
#pfset Geom.sand.Saturation.N            2.9
#pfset Geom.sand.Saturation.SRes         0.05
...
pfset Solver.CLM.MetFileName                            Mar_IPSL-CM5A-MR_clim_Parflow_input.txt 
...
#pfset ICPressure.GeomNames                              domain
#pfset Geom.domain.ICPressure.Value                      -1.95
#
...
set outputdir IPSL-CM5A-CM_hist_Mar
...
file mkdir "$outputdir/$runname.clm_output/can_stor"
...
for {set fileno 0} {$fileno <= [expr $np - 1]} {incr fileno} {
	file copy -force drv_clmin.dat $outputdir/drv_clmin.dat.$fileno
        ...
        file copy -force Mar_IPSL-CM5A-MR_clim_Parflow_input.txt $outputdir/Mar_IPSL-CM5A-MR_clim_Parflow_input.txt.$fileno
        file copy -force Mar_IPSL-CM5A-MR_clim_Parflow_input.txt $outputdir/Mar_IPSL-CM5A-MR_clim_Parflow_input.txt
}
...
for {set fileno 0} {$fileno <= [expr $np - 1]} {incr fileno} {   
	...
	file delete "Mar_IPSL-CM5A-MR_clim_Parflow_input.txt.$fileno"
}}
...
if { $useclm == "true" } {
	...
	set bc_flux [expr $bc_flux - [pfsum $evaptrans]]
       ...
       if {$fexist==1} {
         ...
         set filename [format "%s.out.can_stor.%05d.silo" $runname $i]
         set CanopyStor [pfload $filename]
         pfsave $CanopyStor -sa "CanopyStor.$i.txt"
