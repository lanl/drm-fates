...
export PARAM_ELM_ROOT=$PROJECT_ROOT/$PARAM_ELM_DIR      # PARAM_ELMS_DIR  is set in config.yaml
export PARAM_FATES_ROOT=$PARAM_FATES_DIR                # PARAM_FATES_DIR is set in config.yaml
