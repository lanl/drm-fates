...
with localconverter(robjects.default_converter + pandas2ri.converter):
  df_r = robjects.conversion.py2rpy(df) # in later rpy2 versions use py2rpy
df_r

with localconverter(robjects.default_converter + pandas2ri.converter):
  clone_pd_df_r = robjects.conversion.py2rpy(clone_pd_df) # in later rpy2 versions use py2rpy
clone_pd_df_r
