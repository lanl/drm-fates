...
jobid=$SLURM_JOB_ID
mpiexec -n 2 python /turquoise/usr/projects/higrad/rutuja/DRM/1.FATES-MODEL/src/parallel.run.py -c 'E3SMv2.IELMFATES.badger.intel.C60051649f4-F38708294.2010-2011.' -r /lustre/scratch4/turquoise/rutuja/E3SM/scratch -f clm2.h0.2010-12.nc -s 1 -t 2 -g /turquoise/usr/projects/higrad/rutuja/DRM/1.FATES-MODEL/log
